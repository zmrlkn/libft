...
//	return(0);
//}
//itoa intager to array
//int olarak aldığımız stringi char karaktere çevirmeye yarar
//burada kendi belirlediğimiz tabana göre karakteri veriyoruz ascii tablosuna göre değil